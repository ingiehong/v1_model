...
# Yidong: randomly disconnected 4/7 of synapses to simulate decrease in connection probability
@synaptic_weight
def DirectionRule_EE_Thanos_sg5(edges, src_nodes, trg_nodes):
    src_tuning = src_nodes['tuning_angle'].values
    tar_tuning = trg_nodes['tuning_angle'].values
    x_tar = trg_nodes['x'].values
    x_src = src_nodes['x'].values
    ...
    # Yidong: Randomly set 4/7 of the syn_weight values to 0
    num_to_zero = int(len(syn_weight) * 4 / 7)
...
# Yidong: Strengthen synapses by a 7.5/6.9
@synaptic_weight
def DirectionRule_EE_Strengthen_sg6(edges, src_nodes, trg_nodes):
    src_tuning = src_nodes['tuning_angle'].values
    tar_tuning = trg_nodes['tuning_angle'].values
    x_tar = trg_nodes['x'].values
    x_src = src_nodes['x'].values
...
# Ingie: weaken inhibitory synapses by 22.5 / 31, as measured by Ozkan, 2014 
@synaptic_weight
def DirectionRule_IE_Weaken_sg10(edges, src_nodes, trg_nodes):
    src_tuning = src_nodes['tuning_angle'].values
    tar_tuning = trg_nodes['tuning_angle'].values
    x_tar = trg_nodes['x'].values
    x_src = src_nodes['x'].values
...
# Yidong: randomly disconnected 7/11 of synapses to simulate decrease in connection probability
@synaptic_weight
def DirectionRule_EE_Thanos_sg7(edges, src_nodes, trg_nodes):
    src_tuning = src_nodes['tuning_angle'].values
    tar_tuning = trg_nodes['tuning_angle'].values
    x_tar = trg_nodes['x'].values
    x_src = src_nodes['x'].values
